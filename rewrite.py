...
def update():
    ...
    new_content = """<div id="viewITC508" class="space-y-6">
      <div class="space-y-5">
        <article class="p-6 sm:p-7 rounded-2xl border border-[var(--border-card)] bg-[var(--bg-card)] shadow-[var(--shadow-card)] space-y-4 transition-all duration-200">
          
          <h4 class="text-xl sm:text-2xl font-bold text-[var(--text-card-title)] tracking-tight mb-2">
            Course Expectations
          </h4>
          
          <div class="space-y-6 text-sm leading-relaxed text-[var(--text-card-body)]">
            
            <div class="space-y-2">
              <h5 class="text-base sm:text-lg font-bold text-[var(--text-card-title)] tracking-tight">Addressing Customer Churn with Deep Learning</h5>
            ...
            <div class="space-y-2">
              <h5 class="text-base sm:text-lg font-bold text-[var(--text-card-title)] tracking-tight">Natural Language Processing in Conversational Systems</h5>
              <p class="text-justify">
            ...
            <div class="space-y-2">
              <h5 class="text-base sm:text-lg font-bold text-[var(--text-card-title)] tracking-tight">Reflection and Expectations for ITC-C508</h5>
              <p class="text-justify">
        ...
        <section class="space-y-4 pt-2">
          <h3 class="text-lg sm:text-xl font-bold text-[var(--text-card-title)] tracking-tight px-1">References</h3>
          <div class="space-y-3">
            
            <div class="p-4 sm:p-5 rounded-xl border border-[var(--border-card)] bg-[var(--bg-card)] shadow-[var(--shadow-card)] transition-all duration-200">
              <p class="text-sm text-[var(--text-card-body)] leading-relaxed mb-2.5">
              ...
              <a href="#" class="inline-flex items-center gap-1.5 text-xs font-mono font-medium text-[var(--text-card-muted)] hover:text-[var(--text-page)] transition-colors">
